  ...
  <div class="container">
    <div class="brand">
      <div class="list-brands">
        <div class="item">
          <img src="<?= $img_path; ?>brand1.png" alt="Airdnd" />
        </div>
        <div class="item">
          <img src="<?= $img_path; ?>brand2.png" alt="Coinbuild" />
        </div>
        <div class="item">
          <img src="<?= $img_path; ?>brand3.png" alt="Dirrbble" />
        </div>
        <div class="item">
          <img src="<?= $img_path; ?>brand4.png" alt="Instagirom" />
        </div>
        <div class="item">
          <img src="<?= $img_path; ?>brand5.png" alt="Neetflix" />
        </div>
        <div class="item">
          <img src="<?= $img_path; ?>brand6.png" alt="Pincorest" />
        </div>
      </div>
    ...
    <div class="footer-widgets">
      <div class="row">
        <div class="col-9 widget-products">
          <div class="product">
                ...
                <a href="#">
                  ...
                  <div class="info">
                    ...
                    <div class="star-rating">
                      <img src="<?= $img_path; ?>star-rating-5s.png" alt="" />
                    </div>
        ...
        <div class="col-3 widget-imd">
          <img class="img-fluid" src="<?= $img_path; ?>widget10.jpg" alt="" />
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="footer-newsletter">
    <div class="container">
      <div class="row footer-newsletter-inner">
        <div class="col-7 align-self-center newsletter-content">
          <h5 class="newsletter-title">
            <i class="bi bi-envelope-at"></i>
            Sign up to Newsletter
          </h5>
          <span class="newsletter-marketing">
            ...and receive
            <strong>$20 coupon for first shopping</strong>
          </span>
        </div>

        <div class="col-5 align-self-center d-flex flex-column-reverse justify-content-center footer-newsletter-form">
  ...
  <div class="footer-bottom-widgets">
    <div class="container">
      <div class="footer-bottom-widgets-inner row">
        <div class="footer-contact col-5">
          <div class="footer-logo">
            <svg version="1.1" x="0px" y="0px" width="175.748px" height="42.52px" viewBox="0 0 175.748 42.52"
              ...
              <ellipse class="ellipse-bg" fill-rule="evenodd" clip-rule="evenodd" fill="#FDD700" cx="170.05" cy="36.341"
        ...
        <div class="footer-bottom-widgets-menu col-7">
  ...
  <div class="copyright-bar">
    <div class="container">
      ...
      <div class="float-end payment">
        <img src="<?= $img_path; ?>payment.png" alt="" />
      </div>
    </div>
  </div>
</footer>
