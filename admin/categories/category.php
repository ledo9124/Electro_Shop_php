...
<div class="container category-form">
    ...
    <form action="index.php?act=category" method="post" enctype="multipart/form-data" id="form-category" class="m-5">
        <div class="form-group">
            <label for="category-name">Category name</label>
            <input type="text" rules="required" name="category-name" id="category-name" />
