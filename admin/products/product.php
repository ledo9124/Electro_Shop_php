<div class="container product-form mb-5">
    ...
    <form action="index.php?act=product" method="post" enctype="multipart/form-data" id="form-product" class="m-5">
        <select class="form-select mb-5" aria-label="Default select example" name="category_id">
            <?php 
                ...
                foreach ($listCategories as $key => $category) {
                    ...
                    echo '
                        <option '.($key == 0 ? 'selected' : '').' value="'.$category_id.'">'.$category_name.'</option>
                    ';
                }
            ?>
        ...
        <div class="form-group">
            ...
            <input type="text" rules="required" name="product-name" id="product-name" />
            <span class="form-message"></span>
        </div>
        <div class="form-group">
            <label for="product-price">Product price</label>
            <input type="text" rules="required" name="product-price" id="product-price" />
            <span class="form-message"></span>
        </div>
        <div class="form-group">
            <label for="product-description">Product secription</label>
            <input type="text" rules="required" name="product-description" id="product-description" />
            <span class="form-message"></span>
        </div>
        <div class="form-group">
            ...
            <input rules="isFile" type="file" name="file" id="file" hidden />
            <span class="form-message"></span>
        </div>
